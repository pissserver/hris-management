        ...
        <div class="flex w-full flex-1 flex-col lg:w-1/2">
            <div class="mx-auto flex w-full max-w-md flex-1 flex-col justify-center">
                ...
                <div>
                    ...
                    {{-- Error Alert --}}
                    @if($errors->any())
                    <x-ui.alert variant="error" title="Terjadi Kesalahan" :message="$errors->first()"
                        :showLink="false" />
                    @endif

                    <form action="{{ route('register.process') }}" method="POST" class="mt-5">
                        @csrf
                        <div class="space-y-5">
                            <!-- First Name -->
                            <div>
                            ...
                            <div x-data="{ agree:false }" class="space-y-5">
                                ...
                                <div>
                                    <label
                                        ...
                                        <div class="relative">
                                            <input type="checkbox" name="terms" x-model="agree" class="sr-only">
                        ...
                        : 'border-gray-300 bg-transparent dark:border-gray-700'"
                                ...
                                <!-- Sign Up Button -->
                                <button type="submit" :disabled="!agree" :class="agree
                                    ? 'bg-brand-500 hover:bg-brand-600 cursor-pointer shadow-theme-xs'
                                    : 'bg-gray-300 dark:bg-gray-700 cursor-not-allowed opacity-70'"
                                    class="flex w-full items-center justify-center gap-2 rounded-lg px-4 py-3 text-sm font-medium text-white transition">

                                    <span>Buat Akun</span>

                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" stroke-width="2"
                                        viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M15 19a4 4 0 00-8 0" />
                    ...
                    <div class="mt-5">
                        <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                            Sudah punya akun?
                            <a href="{{ route('login') }}"
                                class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Masuk</a>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="z-1 flex items-center justify-center">
                ...
                <div class="flex max-w-xs flex-col items-center">
                    ...
                    <p class="text-center text-gray-400 dark:text-white/60">
                        PISS Human Resource Information System
                    </p>
                </div>
            </div>
        </div>
