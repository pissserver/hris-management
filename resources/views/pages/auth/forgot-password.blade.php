                ...
                <div>
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Masukkan alamat email yang terhubung dengan akun anda, dan kami akan mengirimkan
                    ...
                    <div>
                        ...
                        <form action="{{ route('otp.request') }}" method="POST" class="mt-5">
                            @csrf
                            <div class="space-y-5">
                                <!-- Email -->
                                <div>
                                    ...
                                    <button type="submit"
                                        ...
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                                d="M3 8l8.89 5.26a2 2 0 002.22 0L23 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                        </svg>
                                    </button>
                                </div>
                            </div>
                        ...
                        <div class="mt-5">
                            <p class="text-center text-sm font-normal text-gray-700 sm:text-start dark:text-gray-400">
                                Tunggu, saya sudah ingat password saya...
                                <a href="{{ route('login') }}"
                                    class="text-brand-500 hover:text-brand-600 dark:text-brand-400">Klik disini</a>
                            </p>
                        </div>
                    </div>
                </div>
