                ...
                <div>
                    <div class="mb-5 sm:mb-8">
                        ...
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            Buat password baru untuk akun anda. Pastikan password yang dibuat kuat dan mudah diingat.
                        </p>
                    </div>
                    <div>
                        ...
                        <form method="POST" action="{{ route('otp.reset') }}" class="mt-5">
                            @csrf
                            ...
                            <div class="space-y-5">
                                ...
                                <div>
                                    ...
                                    <input type="email" name="email" value="{{ old('email',$email) }}" readonly
                                        class="h-11 w-full rounded-lg border border-gray-300 bg-gray-100 px-4 py-2.5 text-sm text-gray-700 dark:border-gray-700 dark:bg-gray-800 dark:text-white" />
                                </div>
                        ...
                        <div class="mt-3">
                            ...
                            <div class="flex items-center justify-center gap-6 text-sm font-medium">
                                ...
                                <a href="{{ route('login') }}" class="text-brand-500 hover:text-brand-600 transition">
                                    Kembali Login
                                </a>
                                ...
                                <form action="{{ route('otp.resend') }}" method="POST">
                                    ...
                                    <button type="submit" class="text-brand-500 hover:text-brand-600 transition">
                                        Kirim OTP
                                    </button>
                                </form>
